---
title: 0014-dsl-driven-rda-code-generation
tags:
  - RFC's
hide:
  - tags
...
- [RFC Proposal](#rfc-proposal)
  ...
  - [Proposed Solution](#proposed-solution)
    - [DSL for RDA API Data](#dsl-for-rda-api-data)
    - [DSL For RIF Data](#dsl-for-rif-data)
    - [Proposed Solution: Detailed Design](#proposed-solution-detailed-design)
      - [DSL Syntax](#dsl-syntax)
      - [Maven Plugin Design](#maven-plugin-design)
      - [Generating JPA Entity classes](#generating-jpa-entity-classes)
      - [Generating Transformation class](#generating-transformation-class)
      - [Field Transformations](#field-transformations)
      - [Array Transformation (Detail records)](#array-transformation-detail-records)
