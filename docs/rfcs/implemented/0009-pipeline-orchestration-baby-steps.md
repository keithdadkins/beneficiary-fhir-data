---
title: 0009-pipeline-orchestration-baby-steps
tags:
  - RFC's
hide:
  - tags
...
- [RFC Proposal](#rfc-proposal)
  ...
  - [Proposed Solution](#proposed-solution)
    ...
    - [Additional Options/Phases](#additional-optionsphases)
      - [Option: Do We Need To Run Jobs In Parallel?](#option-do-we-need-to-run-jobs-in-parallel)
      - [Option: Do We Need Better Obervability?](#option-do-we-need-better-obervability)
      - [Option: Do We Need To Run Jobs On More Than One Host?](#option-do-we-need-to-run-jobs-on-more-than-one-host)
      - [Option: Do We Want a More Off-the-Shelf Job Orchestrator?](#option-do-we-want-a-more-off-the-shelf-job-orchestrator)
      - [Option: Do We Need To "Fan Out" the Execution of a Single Job Across Multiple Workers?](#option-do-we-need-to-fan-out-the-execution-of-a-single-job-across-multiple-workers)
    - [Proposed Solution: Detailed Design](#proposed-solution-detailed-design)
      - [Immediate Changes](#immediate-changes-1)
      - [Option: Do We Need To Run Jobs In Parallel?](#option-do-we-need-to-run-jobs-in-parallel-1)
      - [Option: Do We Need Better Obervability?](#option-do-we-need-better-obervability-1)
